...
import numpy as np
import matplotlib
matplotlib.use("Agg")   # non-interactive backend — safe on servers/headless
...
# ──────────────────────────────────────────────────────────────
# Label map  (must match the sniffer's assign_label output)
# ──────────────────────────────────────────────────────────────
LABEL_NAMES = {
    0: "Normal",
    1: "Port Scan",
...
# ──────────────────────────────────────────────────────────────
# Train / test split  (30 % held-out — unseen data)
# Stratify preserves the class ratio in both splits so results
# are not biased by class imbalance in either subset.
# ──────────────────────────────────────────────────────────────
...
# 5-fold stratified CV tests how the model generalises to
# different subsets — this guards against lucky train/test splits.
# ──────────────────────────────────────────────────────────────
print("\n" + "=" * 60)
